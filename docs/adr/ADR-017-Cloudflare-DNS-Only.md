...
2.  **Architecture Alignment**: Our "Titanium Fortress" strategy emphasizes deep-stack hardening. Geo-blocking and rate-limiting are implemented at the kernel level (nftables), making the Cloudflare WAF redundant for our use case.
