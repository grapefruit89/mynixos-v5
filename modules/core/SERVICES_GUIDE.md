...
- **Zone:** `admin-mtls`, `family-pocketid`, or `public`.

## Automated Consumers
1. **Caddy Module:** Iterates over the spec to create `services.caddy.virtualHosts`. It automatically appends mTLS snippets or Forward-Auth configuration based on the `zone`.
