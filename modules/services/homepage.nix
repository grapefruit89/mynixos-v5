  ...
  config = lib.mkIf config.my.services.homepage.enable {
    services.homepage-dashboard = {
      ...
      services = [
        ...
        { "Infrastructure" = [ { "Pocket-ID" = { icon = "pocket-id.png"; href = "https://${dnsMap.dnsMapping.auth}"; }; } { "Netdata" = { icon = "netdata.png"; href = "https://netdata.${config.my.configs.identity.domain}"; }; } { "Blocky" = { icon = "blocky.png"; href = "https://${dnsMap.dnsMapping.blocky or "dns.m7c5.de"}"; }; } ]; }
      ];
