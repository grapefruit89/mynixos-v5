...
in
{
 ...
 { "Infrastructure" = [ { "OliveTin" = { icon = "olivetin.png"; href = "https://${dnsMap.dnsMapping.olivetin or "olivetin.m7c5.de"}"; }; } { "Pocket-ID" = { icon = "pocket-id.png"; href = "https://${dnsMap.dnsMapping.auth}"; }; } { "Netdata" = { icon = "netdata.png"; href = "https://${dnsMap.dnsMapping.netdata}"; }; } { "AdGuard" = { icon = "adguard-home.png"; href = "https://${dnsMap.dnsMapping.adguard or "adguard.m7c5.de"}"; }; } ]; }
 ];
