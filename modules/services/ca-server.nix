in {
  ...
  config = lib.mkIf config.my.services.caServer.enable {
    ...
    myLib.mkHardenedService {
      ...
      extraConfig = {
        ...
        # Allow Unix sockets for Gunicorn
        RestrictAddressFamilies = [ "AF_UNIX" ];
        # Python needs some memory space
        MemoryDenyWriteExecute = false; # Often needed for Python
      };
    }
